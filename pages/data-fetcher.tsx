...
import LSP1DataKeys from '@desights/erc725.js/schemas/LSP1UniversalReceiverDelegate.json';
import LSP3DataKeys from '@desights/erc725.js/schemas/LSP3ProfileMetadata.json';
import LSP4DataKeys from '@desights/erc725.js/schemas/LSP4DigitalAsset.json';
import LSP5DataKeys from '@desights/erc725.js/schemas/LSP5ReceivedAssets.json';
import LSP6DataKeys from '@desights/erc725.js/schemas/LSP6KeyManager.json';
import LSP8DataKeys from '@desights/erc725.js/schemas/LSP8IdentifiableDigitalAsset.json';
import LSP9DataKeys from '@desights/erc725.js/schemas/LSP9Vault.json';
